 ...
 * - Set VITE_API_URL to override (e.g. http://localhost:8000 locally, or /api for Vercel serverless).
 */
const API_BASE = import.meta.env.VITE_API_URL || "https://metricare.onrender.com";
