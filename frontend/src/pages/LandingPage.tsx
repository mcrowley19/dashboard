    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM12 10.5a.75.75 0 01.75.75v.75h.75a.75.75 0 010 1.5h-.75v.75a.75.75 0 01-1.5 0v-.75h-.75a.75.75 0 010-1.5h.75v-.75a.75.75 0 01.75-.75z"
        />
      </svg>
    ),
  },
...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[60vh] w-full overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-center pl-[12%] pr-[8%] md:pl-[14%] max-w-xl text-left pointer-events-none">
          <div className="pointer-events-auto">
            ...
            >
              Patient history and AI in one place. A medical dashboard that
              stays clear and up to date.
            </p>
            <div
      ...
      <section
        id="about"
        className="relative py-16 md:py-24 px-6 md:px-10 bg-white"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-600 text-lg leading-relaxed">
              A medical dashboard built for the way clinicians work today.
              Patient history, real-time data, and AI in one up-to-date
              view—without the clutter and bloat.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {tiles.map((tile, i) => (
              <article
                key={i}
                className="group rounded-2xl border border-gray-100 p-6 md:p-7 hover:shadow-sm hover:border-gray-200 transition-all duration-200"
              >
